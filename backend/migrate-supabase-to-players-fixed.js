...
async function migrateSupabaseToPlayersFixed() {
  try {
    ...
    existingTeams.forEach(team => {
      ...
      const player1FirstName = team.player1FirstName?.trim();
      const player1LastName = team.player1LastName?.trim();
      const player2FirstName = team.player2FirstName?.trim();
      const player2LastName = team.player2LastName?.trim();
      const phoneNumber = team.phoneNumber?.trim();
